        ...
        $.fn.LanguageSwitcher = function(op) {
            ...
            function init() {
                ...
                {                                    
                    ...
                    triggerEvent({name: 'onChange', selectedItem: selectedlanguage, element: rootElement, instance: ls});
                }
                if (selectedItem) {
	...
	// });
        ...
        $('.contains-info').click(function(e) {
            ...
            if ($(this).prev().hasClass('toggled')) {
                $(this).html('<label class="showinfo">' + showinfo + '</label>').removeClass('text-toggled');
                $(this).prev().slideToggle().removeClass('toggled');
            } else {
                if ($(this).prev().children(".tooltip-content-" + selectedlanguage).length > 0)
                {
                    $(this).prev().children().each(function(i, elm) {
                        if ($(elm).hasClass("tooltip-content-" + selectedlanguage))
                            $(elm).show();
                        else
                            $(elm).hide();
                    });
                ...
                $('.toggled').next().html('<label class="showinfo">' + showinfo + '</label>');
                $('.toggled').slideToggle().removeClass('toggled');
                $(this).prev().slideToggle().addClass('toggled');
                $(this).html('<label class="hideinfo">' + hideinfo + '</label>').addClass('text-toggled');
            }
        });
